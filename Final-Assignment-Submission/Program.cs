        ...
        static void Main(string[] args)
        {
            ...
            var studentInfos = new List<StudentInfo>
            {
                new StudentInfo {
                    ...
                    DateOfBirth = new DateTime(1999, 4, 22),
                    Height = 185.3m,
                    Weight = 78.9f,
                    Department = "Game Development",
                    Section = "3D Graphics",
                    Courses = new List<string> { "Unity Engine", "C# Programming", "3D Modeling", "Game Physics", "Character Animation", "Level Design", "Game Audio", "Mobile Game Development" }
                }
            };
